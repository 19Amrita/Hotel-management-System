...
public class Reception extends JFrame implements ActionListener{
     ...
     JButton department,newCustomer,rooms,allEmployee,customerInfo, manager,checkOut,update,roomStatus,pickup,serachRoom, logout;
    Reception(){
    ...
    pickup.setForeground(Color.WHITE);
     pickup.addActionListener(this);
        add(pickup);
          ...
          serachRoom = new JButton("Search Room");
       serachRoom.setBounds(10,430,200,30);
       serachRoom.setBackground(Color.BLACK);
    serachRoom.setForeground(Color.WHITE);
     serachRoom.addActionListener(this);
        add(serachRoom);
    ...
    public void actionPerformed (ActionEvent ae){
        ...
        if(ae.getSource()== newCustomer){
         ...
         else if(ae.getSource()==serachRoom){
           setVisible(false);
            new SearchRoom(); 
        }
